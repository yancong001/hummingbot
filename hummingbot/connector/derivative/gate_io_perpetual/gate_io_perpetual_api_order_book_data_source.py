...
class GateIoPerpetualAPIOrderBookDataSource(PerpetualAPIOrderBookDataSource):
    ...
    async def _order_book_snapshot(self, trading_pair: str) -> OrderBookMessage:
        ...
        snapshot_msg: OrderBookMessage = OrderBookMessage(
            OrderBookMessageType.SNAPSHOT,
            {
                ...
                "bids": [[i['p'], self._connector._format_size_to_amount(trading_pair,Decimal(str(i['s'])))] for i in snapshot_response["bids"]],
                "asks": [[i['p'], self._connector._format_size_to_amount(trading_pair,Decimal(str(i['s'])))] for i in snapshot_response["asks"]],
            },
    ...
    async def _parse_order_book_diff_message(self, raw_message: Dict[str, Any], message_queue: asyncio.Queue):
        ...
        order_book_message_content = {
            ...
            "bids": [[i['p'], self._connector._format_size_to_amount(trading_pair,Decimal(str(i['s'])))] for i in diff_data["b"]],
            "asks": [[i['p'], self._connector._format_size_to_amount(trading_pair,Decimal(str(i['s'])))] for i in diff_data["a"]],
        }
