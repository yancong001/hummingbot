...
class PerpCrossExchangeMarketMakingStrategy(StrategyPyBase):
    ...
    def init_params(self,
                    config_map: PerpCrossExchangeMarketMakingConfigMap,
        ...
        """
        Initializes a perp cross exchange market making strategy object.

        :param config_map: Strategy configuration map
        :param market_pairs: list of perp cross exchange market pairs
    ...
    def tick(self, timestamp: float):
        ...
        For perp cross exchange market making strategy, this function mostly just checks the readiness and connection
    ...
    async def process_market_pair(self, timestamp: float, market_pair: MarketTradingPairTuple, active_orders: List):
        ...
        :param market_pair: perp cross exchange market pair
    ...
    async def get_market_making_size(self,
        ...
        :param market_pair: The perp cross exchange market pair to calculate order price/size limits.
