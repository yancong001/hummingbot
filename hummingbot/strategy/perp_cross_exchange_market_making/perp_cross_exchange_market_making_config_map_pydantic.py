...
class OracleConversionRateMode(ConversionRateModel):
    ...
    def get_conversion_rates(
        ...
        """
        from .perp_cross_exchange_market_making import PerpCrossExchangeMarketMakingStrategy
        ...
        gas_pair = None
        if PerpCrossExchangeMarketMakingStrategy.is_gateway_market(market_pair.taker):
...
class PerpCrossExchangeMarketMakingConfigMap(BaseTradingStrategyMakerTakerConfigMap):
    ...
    order_amount: Decimal = Field(
        ...
        ge=0.0,
        client_data=ClientFieldData(
            prompt=lambda mi: PerpCrossExchangeMarketMakingConfigMap.order_amount_prompt(mi),
            prompt_on_new=True,
        )
    )
    ...
    top_depth_tolerance: Decimal = Field(
        ...
        ge=0.0,
        client_data=ClientFieldData(
            prompt=lambda mi: PerpCrossExchangeMarketMakingConfigMap.top_depth_tolerance_prompt(mi),
        ),
    )
    ...
    taker_market: ClientConfigEnum(
        ...
        default=...,
        description="The name of the taker derivative exchange connector.",
        client_data=ClientFieldData(
            prompt=lambda mi: "Enter your taker derivative connector",
            prompt_on_new=True,
        ),
    )
    maker_market: ClientConfigEnum(
        ...
        default=...,
        description="The name of the maker derivative exchange connector.",
        client_data=ClientFieldData(
    ...
    @classmethod
    def top_depth_tolerance_prompt(cls, model_instance: 'PerpCrossExchangeMarketMakingConfigMap') -> str:
    ...
    @classmethod
    def order_amount_prompt(cls, model_instance: 'PerpCrossExchangeMarketMakingConfigMap') -> str:
