...
from .wt_pure_market_making_order_tracker import WtPureMarketMakingOrderTracker
...
cdef class WtPureMarketMakingStrategy(StrategyBase):
    ...
    def init_params(self,
                    ...
                    order_level_spread_upper_factor: Decimal = Decimal("1"),
                    order_level_amount: Decimal = s_decimal_zero,
                    order_level_amount_upper_factor: Decimal = Decimal("1"),
        ...
        self._sb_order_tracker = WtPureMarketMakingOrderTracker()
        ...
        self._base_order_level_spread = order_level_spread
        self._order_level_spread_upper_factor = order_level_spread_upper_factor
        self._order_level_amount = order_level_amount
        self._base_order_level_amount = order_level_amount
        self._order_level_amount_upper_factor = order_level_amount_upper_factor
    ...
    cdef c_tick(self, double timestamp):
        ...
        try:
            ...
            if not self._all_listener_ready:
                if not self._all_listener_ready:
                    self._market_info.market.get_order_book(self.trading_pair).add_listener(
    ...
    cdef object c_create_wash_trading_proposal(self):
        cdef:
            ExchangeBase market = self._market_info.market
            list buys = []
            list sells = []
    ...
    cdef tuple c_get_top_bid_ask(self):
        ...
        top_bid_price = market.c_get_price(self.trading_pair, False)

        top_ask_price = market.c_get_price(self.trading_pair, True)
